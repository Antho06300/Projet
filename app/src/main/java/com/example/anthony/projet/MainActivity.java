...
public class MainActivity extends Activity {
    ...
    private static ImageView bateau;
    private static ImageView camion;
    private static ImageView fusee;
    private static ImageView taxi;
    private static ImageView velo;

    private static ImageView black;
    private static ImageView blue;
    private static ImageView green;
    private static ImageView yellow;
    private static ImageView red;

    private static TextView un;
    private static TextView deux;
    private static TextView trois;
    private static TextView quatre;
    private static TextView cinq;
